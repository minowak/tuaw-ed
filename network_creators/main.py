...
from network_creators.author_user_user_comments import AuthorUserUserComments
...
from network_creators.comments_tuaw_urls import CommentsTuawUrls
...
create_gexf(AuthorUserUserComments(''), 'author-user-user-comments.gexf')